...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 09, 2022 lúc 06:02 AM
...
--
-- Cơ sở dữ liệu: `1951060834_libraries`
--
...
(123, 'long', 1, '0000-00-00', 'sinh vien', '0000-00-00', '0000-00-00', '');
...
--
ALTER TABLE `docgia`
  MODIFY `madg` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
COMMIT;
